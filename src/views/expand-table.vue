...
<template>
    ...
    <a-table :columns="columns" :data="dataList" v-model:expandedKeys="expandedKeys" :row-selection="rowSelection"
        style="margin-top: 20px" @expand="onExpand" />
</template>
...
function onExpand(BaseType, record) {
    console.log(BaseType, record);
